...
VALUES ('$serial','Operation','$date','$modeofpay','$votehead1','$cashes[$counter]','$term','$year','OK','$username','$amount','$words','$bankname','-','Operation Income','$bankreceipt') on duplicate key update receipt_no='$serial'";
