...
<div id="page_tabs">
  <ul>
     <li><a href="finance_payables.php">Outstanding GRNs</a></li>
	<li><a    class="active" href="finance_payable_list.php">Suppliers List</a></li>
  </ul>
</div>
<div id="display_Area">
  ...
  <tr style='height:30px;'>
    <td class='dataListHeader' colspan='4'>Suppliers List
      <div style="float:right; margin-right:20px; width:60%;">
        <table width="80%" align="right">
          <tr>
		   <td><i class="icon icon-red icon-plus"></i>Add Suppplier</td>
            <td align="right"><a href="finance_payable_list.php" title="Refresh Page"><i class="icon icon-green icon-refresh"></i>Refresh</a></td>
			<td align="center"><a href="pdf_suppliers.php"><img src="images/printer.png" align="absmiddle" />Print</a></td>
          </tr>
        </table>
      </div></td>
  </tr>
  <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<tbody>
        <?php
		  $result = mysql_query("SELECT * FROM purchase_orders order by supplier desc");
		$num=0;
