...
$pdf->setXY($x, $y);
 ...
 if($_GET['id']=="available"){
$sql ="SELECT * FROM studentdetails where form='FORM 1' Or form='FORM 2' or form='FORM 3' or form='FORM 4' order by form asc, class asc, fname asc";
}else{
$sql ="SELECT * FROM studentdetails where form='FORM 5' order by year_finished asc, class asc, fname asc";
}
