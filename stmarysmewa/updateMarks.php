	...
	and term='$term' and year='$year' and admno='$admn'";//update cat 1
	 ...
	 $result2 = mysql_query($query2);
	  $result3 = mysql_query($query3);
		...
		?>
		<script language=javascript>window.location='manage_student_marks.php?id=<?php echo $form;?>&term=<?php echo $term;?>&year=<?php echo $year;?>&subject=<?php echo $toupdate;?>&stream=<?php echo $stream;?>'</script>
		<?php
		}
