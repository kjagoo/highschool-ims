  ...
  <tr>
	...
	<?php
      ...
      <a class='subMenuItem' href="system.php" target="content"><i class="icon icon-green icon-wrench"></i>&nbsp;System Setup</a> 
	   ...
	   <a class='subMenuItem' href="system_enrollment.php" target="content"><i class="icon icon-green icon-document"></i>&nbsp;School Enrollment</a> 
	   <?php }
	     if($usercat=='Administrator' ||  $usercat=='Accountant' || $usercat=='Secretary'){
	   ?>
