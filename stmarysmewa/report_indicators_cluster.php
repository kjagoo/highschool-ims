...
<div id="page_tabs">
  <ul>
    <li><a  href="report_indicators.php">School Based Exams P.I.</a></li>
    <li><a class="active"   href="report_indicators_cluster.php">Cluster Exams P.I.</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
    <fieldset>
    <form name="pays" action="report_indicators_view_cluster.php" method="post" target="reportView">
      <table width="100%">
	  <tr>
    ...
    <iframe name="reportView" src="report_indicators_view_cluster.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
    <?php
