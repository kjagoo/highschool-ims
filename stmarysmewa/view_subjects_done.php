...
$data[] = $row['admno'];
	...
	$ful2=$mname;
	$ful3=$lname;
	$act="insert into subjectsforstudent (admno,subjects,form,fname,mname,lname,religion,year,term) values('$adm','$subjects','$frms','$ful','$ful2','$ful3','$religion','$year','$term') on duplicate key update religion='$religion'";
