...
<div id="new_Area">
  ...
  <div id="display_Area">
    <div id="page_tabs_content">
	 ...
	 $query = "select k.admno, k.index_numbers,k.year_finished, s.admno, s.fname,s.sname,s.lname from kcseanalysis as k inner join studentdetails s on k.admno=s.admno and k.year_finished='$year' order by k.index_numbers";
	  $result = mysql_query($query);
		...
		$indexno=$row['index_numbers'];
		 ...
		 ?>
                <tr>
                  ...
                  <td><span id=freetext>
                    <input type="text" value="<?php echo $indexno?>" name="adms" id="idn" readonly="readonly" size="8" >
                    </span></td>
