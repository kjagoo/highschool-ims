...
<div id="page_tabs">
  <ul>
    <li><a href="report_spreadsheet.php">General Spreadsheet</a></li>
    <li><a   class="active"  href="report_spreadsheet_cluster.php">Cluster Spreadsheet</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
      <fieldset>
      <form name="pays" action="report_viewspreadsheet_cluster.php" method="get" target="reportView">
        <table width="100%">
          <tr>
            <td>Select Form:</td>
