...
<div id="page_tabs">
  <ul>
    <li><a class="active" href="sms_alumni.php">SMS to Alumni</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
 <div id="page_tabs_content">
  <form id="contact-form" action="send_sms_to_alumni.php" name="sendsms" method="post">
        ...
        <tr style="height:30px;">
          <td class="dataListHeader" colspan="2">Send Message To Parents</td>
                        ...
                        <tr>
                          <td>Select Year Finished School</td>
                          <td><select name="yearf" class="select" tabindex="1">
