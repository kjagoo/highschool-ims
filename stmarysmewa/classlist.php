...
if($genders=="Entire"){
$query = "SELECT * FROM studentdetails where form='$form' and class='$stream' order by admno asc";
}
if($genders=="Boys"){
$query = "SELECT * FROM studentdetails where form='$form' and class='$stream' and gender='Male'  order by admno asc";
}
if($genders=="Girls"){
$query = "SELECT * FROM studentdetails where form='$form' and class='$stream' and gender='Female'  order by admno asc";
}
  ...
  <form  method='get' name='subs'>
    <div id=tabledisplay>
      <table class='borders' cellpadding='5' cellspacing="0">
		...
		$mname=strtoupper(str_replace("&","'",$row['sname']));
		$lname=strtoupper(str_replace("&","'",$row['lname']));
		$formis=$row['form'];
