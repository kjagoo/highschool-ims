...
<div id="page_tabs">
  <ul>
    <li><a  class="active"  href="report_forms.php">General Report Forms</a></li>
    <li><a  href="report_forms_cluster.php">Cluster Report Forms</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
    <fieldset>
    <form name="pays" action="report_forms_view_general.php" method="get" target="reportView">
      <table width="100%">
	  <tr>
          <td><select name="amode" class="select" required>
        ...
        <tr>
		  ...
		  <option value="" >-- Select Year -- </option>
			...
			<select name="gradeby" class="select" required>
		  <option value="" >-Grade Using-</option>
              <option value="marks">Total Marks</option>
              <option value="points">Total Points</option>
            </select>
          </td>
          <td align="center"><input type="submit" name="Record" value="Generate Reports" class="btn btn-primary" onclick="return validateForm();"/></td>
        </tr>
      </table>
    </form>
    </fieldset>
    <iframe name="reportView" src="report_forms_view.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
    <?php
