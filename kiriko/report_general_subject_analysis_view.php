    ...
    <body>
        ...
        <div id="display_Area">
            <div id="page_tabs_content">
                ...
                $func = new Functions();
                $activity = "Generated exam analysis $exam " . $myform . " " . $year . " " . $term;
                            ...
                            <div style="float:right; margin-right:5px;">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="left"><a href="pdf_test_gen.php?form=<?php echo $form?>&term=<?php echo $term?>&year=<?php echo $year?>&exam=<?php echo $exam?>" title="Print PDF Report"><i class="icon icon-red icon-pdf"></i>Export PDF</a> </td>
                        ...
                        <td>
                            <form  method='get' name='pdiv' id="pdiv">
                                <div id="div_print_analysis">
									...
									array_push ($allStreams,$rowg['stream']) ;
									}
                                    ...
                                    foreach ($subjects AS $subject) {
										...
										if($exam=="totalygradedmarks"){
                                            ...
                                            //GET GRADES
											if($exam=="totalygradedmarks"){
                                            $retGrades = getGrades("getGradesPerSubject",$subject, $form, $strm, $term, $year, $subgrade);
											}else{
												$retGrades = getGrades("getGradesPerSubjectMID",$subject, $form, $strm, $term, $year, $subgrade);
										...
										if($exam=="totalygradedmarks"){	
                                            ...
                                            $engint = mysql_query("select initials from initials where  form='$myform' and stream='$strm' and subject='$initsub'");
                                        ...
                                        printGradeHeader($subject, $allStreamRowData);
											...
											printGradeHeader(strtoupper($subject), $allStreamRowData);
										}
                                        if ($loopcounter > 0) {
                                            echo "</fieldset>";
                                        }
                                    ...
                                    function getGrades($getGradesFunction,$subject1, $form1, $stream1, $term1, $year1, $subjectGrade) {
                                        $stally = new SubjectTally();
                                        $gradesArray = array();

                                        $englishtallys = $stally->$getGradesFunction($subject1, $subjectGrade, $term1, $year1, $form1, $stream1);
