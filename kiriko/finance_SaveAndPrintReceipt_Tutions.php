...
function printDiv(divId) {
	...
	window.location='finance_collect_operation.php';
}
 function Redirect(){
 window.location='finance_collect_operation.php';
 }
   ...
   <ul>
    <li><a href="finance_collect_fees.php">Collect Fees</a></li>
	 ...
	 <li><a  href="finance_collect_operation.php">Operation Distribution</a></li>
	  <li><a  class="active"  href="finance_collect_tution.php">Tution Distribution</a></li>
...
<div id="display_Area">
 ...
 $sqlquly = "select * from finance_tuitionvoteheads where fiscal_year='$year' and term='$term' order by votehead asc ";
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd1 )) {
		...
		$words=str_replace("point zero zero","",ucfirst(convert_number_to_words($amount)))."  Shillings only";
...
VALUES ('$serial','Tutition','$date','$modeofpay','Tution','$votehead1','$cashes[$counter]','$term','$year','OK','$username','$amount','$words','$bankname','-','Tution Income','$bankreceipt') on duplicate key update receipt_no='$serial'";
    ...
    <div id=tableReceipt>
            ...
            <table width="100%" border="0">
             <tr>
              ...
              <tr>
                <td>Received From </td>
                <td colspan="3"><span id="receiptText">GOV.</span></td>
              ...
              <tr>
                <td>Amount (Words) </td>
                <td colspan="5"><span id="receiptText"><?php echo str_replace("point zero zero","",ucfirst(convert_number_to_words($amount))); ?>&nbsp; Shillings only</span></td>
              </tr>
			  <tr>
                <td>Being Payment for: </td>
                <td colspan="5"><span id="receiptText">Tution <?php echo $year." ".$term?></span></td>
              </tr>
            </table></td>
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd1 )) {
		...
		if($cashes[$counters]==0){
			 ...
			 echo "<tr><td><span id=receiptText>$votehead1s &nbsp;</span></td>
				<td><span id=receiptText>Tution $term &nbsp;&nbsp;$year</span></td>
			...
			?>
              ...
              <tr>
                <td colspan="3">Chq No/ Money Order No<span id="receiptText"><strong> # <?php echo $bankname .":S/N ".$bankreceipt    ;?></strong></span> &nbsp;&nbsp;<i>You were served by: <span id="receiptText"><?php echo getLoggedUser($user_id);;?></i> <!--<I>***Advice not valid unless Transaction Number is shown***</I> --></span></td>
              </tr>
			  <tr>
