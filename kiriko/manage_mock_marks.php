...
//if ($result) {
  ...
  ?>
   <div class="clear"></div>
	...
	$ads = "SELECT admno FROM studentdetails where form='$form' and class='$stream'";//admno query
	...
	$exam = "SELECT $subject1,$subject2,$subject3 FROM mockexams where form='$myform' and term='$term' 
