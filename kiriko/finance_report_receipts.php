  ...
  <ul>
   <li><a href="finance_report_statements.php">Fees Statements</a></li>
	...
	<li><a  href="finance_report_feeregister.php">Fees Register</a></li>
	 ...
	 <li><a  class="active"  href="finance_report_receipts.php">Receipts</a></li>
...
<div class="clear"></div>
  ...
  <form method="get" action="finance_report_view_receipts.php" target="reportView">
    <fieldset>
    <table width="90%">
      <tr>
        <td><table width="100%">
  ...
  <iframe name="reportView" src="finance_report_view_receipts.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
