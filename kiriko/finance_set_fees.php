...
<table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
  <tr style='height:30px;'>
    <td class='dataListHeader' colspan='4'>Setting Fees Current Open Year: <?php echo $year?>
	<div style="float:right; margin-right:20px">
		  <table width="150px;"><tr><td align="center"><a href="finance_set_fees.php?term=<?php echo $terms?>&form=<?php echo $forms?>&yr=<?php echo $year?>" title="Refresh Page"><i class="icon icon-green icon-refresh"></i>Refresh</a></td><td align="right"><a href="finance_setfees.php" title="Previous Page" target="content"><i class="icon icon-red icon-close"></i>Back</a></td></tr></table></div>
	</td>
  </tr>
  <td>
  <?php
  
		  $result = mysql_query("select * from finance_voteheads where fiscal_year='$year' and term='$terms' order by votehead asc");
