...
<div id="page_tabs">
  <ul>
    <li><a  class="active"  href="report_indicators.php">School Based Exams P.I.</a></li>
    <li><a  href="report_indicators_cluster.php">Cluster Exams P.I.</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
    <fieldset>
    <form name="pays" action="report_indicators_view.php" method="post" target="reportView">
      <table width="100%">
	  <tr>
        ...
        <tr>
		  ...
		  <option value="" >-- Select Exam -- </option>
              ...
              <option value="Exam" >End Term</option>
            </select>
			</td>
          <td align="center"><input type="submit" name="Record" value="View Reports" class="btn btn-primary" onclick="return validateForm();"/></td>
        </tr>
      </table>
    </form>
    </fieldset>
    <iframe name="reportView" src="report_indicators_view.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
    <?php
