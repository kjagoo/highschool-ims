...
<?php
if($usercat=='Administrator' || $usercat=='Secretary'|| $usercat=='Dean' || $usercat=='Accountant' || $usercat=='Deputy' || $usercat=='ICT'){ ?>
...
if($usercat=='Administrator' || $usercat=='Deputy' || $usercat=='ICT'|| $usercat=='Government Teacher' || $usercat=='Board Teacher' || $usercat=='Dean' || $usercat=='Secretary' || $usercat=='Guidance'){ ?>
<li><a class='subMenuItem' href="classlist.php" target="content"><i class="icon icon-blue icon-document"></i>&nbsp;Class List</a></li>
<?php
}
if($usercat=='Administrator' || $usercat=='Deputy' || $usercat=='Guidance'){?>
<li><a class='subMenuItem' href="guidance.php" target="content"><i class="icon icon-blue icon-pin"></i>&nbsp;Guidance</a></li> 
<?php	
}


if($usercat=='Administrator' || $usercat=='Deputy' || $usercat=='ICT'|| $usercat=='Guidance'|| $usercat=='Government Teacher' || $usercat=='Board Teacher' || $usercat=='Dean'){ ?>
	...
	<ul style="list-style:none; margin:0 0 0 10px; padding:0;">
	   <li> <a class='subMenuItem' href="marks_set.php" target="content"><i class="icon icon-blue icon-check"></i>&nbsp;Set Marks </a> </li>
	    <li> <a class='subMenuItem' href="marks_students.php" target="content"><i class="icon icon-blue icon-check"></i>&nbsp;Students per Subject</a> </li>
...
if($usercat=='Administrator'  || $usercat=='Dean' || $usercat=='Deputy' || $usercat=='ICT'){ ?>
	<div class='subMenuHeader'>Reports</div>
	<ul style="list-style:none; margin:0 0 0 10px; padding:0;">	
	<li> <a class='subMenuItem' href="reports_halfterm.php" target="content"><i class="icon icon-blue icon-doc"></i>&nbsp;Tune-Up/Mid-Term</a></li>
