...
function Header(){
	...
	$this->Text(75, 35, 'END TERM Analysis Form '.$form.' '.$strm.' Term '.$term.' Year '.$year);
...
if($positionby=="marks"){
	...
	if($strm=="Entire"){
//$sql="select * from totalygradedmarks where form='$form' and term='$term' and year='$year' order by $positionby desc, $alternatepositionby desc";
//$sql="select * from totalygradedmarks where form='$form' and term='$term' and year='$year' order by $positionby desc, $alternatepositionby desc";
...
//$sql="select * from totalygradedmarks where form='$form' and strm='$strm' and term='$term' and year='$year' order by $positionby desc, $alternatepositionby desc";
$sql="SELECT t2.*, ROWNUM FROM (
    SELECT q1.*, MIN(q1.rownum) AS rownum FROM 
    (SELECT t1.".$positionby.",t1.".$alternatepositionby.", @rownum:=@rownum + 1 AS rownum
        FROM totalygradedmarks t1, (SELECT @rownum:=0) r where t1.form = '$form' and t1.term='$term' and t1.year='$year'  and t1.classin='$strm'
...
$vap=0;
	...
	$pdf->setXY($x, $y);
	 ...
	 if($strm=='Entire'){
		...
		$geta = mysql_query("select count(tgrade) as a from totalygradedmarks where tgrade='A' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getam = mysql_query("select count(tgrade) as am from totalygradedmarks where tgrade='A-' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getbp = mysql_query("select count(tgrade) as bp from totalygradedmarks where tgrade='B+' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getbs = mysql_query("select count(tgrade) as bs from totalygradedmarks where tgrade='B' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getbm = mysql_query("select count(tgrade) as bm from totalygradedmarks where tgrade='B-' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getcp = mysql_query("select count(tgrade) as cp from totalygradedmarks where tgrade='C+' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getcs = mysql_query("select count(tgrade) as cs from totalygradedmarks where tgrade='C' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getcm = mysql_query("select count(tgrade) as cm from totalygradedmarks where tgrade='C-' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getdp = mysql_query("select count(tgrade) as dp from totalygradedmarks where tgrade='D+' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getds = mysql_query("select count(tgrade) as ds from totalygradedmarks where tgrade='D' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getdm = mysql_query("select count(tgrade) as dm from totalygradedmarks where tgrade='D-' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$getes = mysql_query("select count(tgrade) as esd from totalygradedmarks where tgrade='E' and term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
	...
	$pdf->setX(25);
	$pdf->setFont("times","B","12");
	$pdf->Cell(218, 7, "Notes", 1, 0, "L", 1);
	$pdf->Ln();
	$pdf->setX(25);
	$pdf->Cell(218, 7, "P.I (Performance Index)= Current MSS - PREVIOUS MSS", 1, 0, "L", 1);
	$pdf->Ln();
	$pdf->setX(25);
	$pdf->Cell(218, 7, "V.A.P (Value Added Progress)= Current MSS - KCPE MSS", 1, 0, "L", 1);
...
$studentsare=0;
	...
	$getstudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm'");
	}
...
$englishas = 0; 
	...
	$englishtallys = $stally -> getGradesPerSubject("english","englishgrade", $term,$year,$form,$strm); 
...
//************************************************** french **************************************************************************
 ...
 $frenchde = 0;  
	...
	$frenchtallys = $stally -> getGradesPerSubject("french","frenchgrade", $term,$year,$form,$strm); 
	                           //getGradesPerSubject("frenchgrade", $term,$year,$form,$strm);
	}
 ...
 $homede = 0;  
	...
	$hometallys = $stally -> getGradesPerSubject("home","homegrade", $term,$year,$form,$strm); 
...
//***************************************************************************************************
 ...
 $computerde = 0;  
	...
	$computertallys = $stally -> getGradesPerSubject("computer","computergrade", $term,$year,$form,$strm); 
...
//***********************************************************************************************************8
	...
	if($strm=='Entire'){
		...
		$kistally=$stally->getSubjectTally('kiswahiligrade','A',$term,$year,$form," and classin='$strm'");
		$kisas=$kistally['tally'];
		$kisA=$kisas*12;
	}
	...
	if($strm=='Entire'){
		...
		$kistally=$stally->getSubjectTally('kiswahiligrade','B+',$term,$year,$form," and classin='$strm'");
		$kisbp=$kistally['tally'];
		$kisBP=$kisbp*10;
	}
	...
	if($strm=='Entire'){
		...
		$kistally=$stally->getSubjectTally('kiswahiligrade','C+',$term,$year,$form," and classin='$strm'");
		$kiscp=$kistally['tally'];
		$kisCp=$kiscp*7;
	}
	...
	if($strm=='Entire'){
		...
		$kistally=$stally->getSubjectTally('kiswahiligrade','D+',$term,$year,$form," and classin='$strm'");
		$kisdp=$kistally['tally'];
		$kisDp=$kisdp*4;
	}
	...
	if($strm=='Entire'){
		...
		$kistally=$stally->getSubjectTally('kiswahiligrade','E',$term,$year,$form," and classin='$strm'");
		$kisde=$kistally['tally'];
		$kisE=$kisde*1;
	}
	...
	if($strm=='Entire'){
		...
		$mathtally=$stally->getSubjectTally('mathimaticsgrade','A',$term,$year,$form," and classin='$strm'");
		$mathas=$mathtally['tally'];
		$mathA=$mathas*12;
	}
	...
	if($strm=='Entire'){
		...
		$mathtally=$stally->getSubjectTally('mathimaticsgrade','B+',$term,$year,$form," and classin='$strm'");
		$mathbp=$mathtally['tally'];
		$mathBP=$mathbp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$mathtally=$stally->getSubjectTally('mathimaticsgrade','C+',$term,$year,$form," and classin='$strm'");
		$mathcp=$mathtally['tally'];
		$mathCp=$mathcp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$mathtally=$stally->getSubjectTally('mathimaticsgrade','D+',$term,$year,$form," and classin='$strm'");
		$mathdp=$mathtally['tally'];
		$mathDp=$mathdp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$mathtally=$stally->getSubjectTally('mathimaticsgrade','E',$term,$year,$form," and classin='$strm'");
		$mathde=$mathtally['tally'];
		$mathE=$mathde*1;
	}
	...
	if($strm=='Entire'){
		...
		$biotally=$stally->getSubjectTally('biologygrade','A',$term,$year,$form," and classin='$strm'");
		$bioas=$biotally['tally'];
		$bioA=$bioas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$biotally=$stally->getSubjectTally('biologygrade','B+',$term,$year,$form," and classin='$strm'");
		$biobp=$biotally['tally'];
		$bioBP=$biobp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$biotally=$stally->getSubjectTally('biologygrade','C+',$term,$year,$form," and classin='$strm'");
		$biocp=$biotally['tally'];
		$bioCp=$biocp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$biotally=$stally->getSubjectTally('biologygrade','D+',$term,$year,$form," and classin='$strm'");
		$biodp=$biotally['tally'];
		$bioDp=$biodp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$biotally=$stally->getSubjectTally('biologygrade','E',$term,$year,$form," and classin='$strm'");
		$biode=$biotally['tally'];
		$bioE=$biode*1;
	}
	...
	$getbiostudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and biology>0");
	}
	...
	if($strm=='Entire'){
		...
		$chemtally=$stally->getSubjectTally('chemistrygrade','A',$term,$year,$form," and classin='$strm'");
		$chemas=$chemtally['tally'];
		$chemA=$chemas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$chemtally=$stally->getSubjectTally('chemistrygrade','B+',$term,$year,$form," and classin='$strm'");
		$chembp=$chemtally['tally'];
		$chemBP=$chembp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$chemtally=$stally->getSubjectTally('chemistrygrade','C+',$term,$year,$form," and classin='$strm'");
		$chemcp=$chemtally['tally'];
		$chemCp=$chemcp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$chemtally=$stally->getSubjectTally('chemistrygrade','D+',$term,$year,$form," and classin='$strm'");
		$chemdp=$chemtally['tally'];
		$chemDp=$chemdp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$chemtally=$stally->getSubjectTally('chemistrygrade','E',$term,$year,$form," and classin='$strm'");
		$chemde=$chemtally['tally'];
		$chemE=$chemde*1;
	}
	...
	$getchemstudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and chemistry>0");
	}
	...
	if($strm=='Entire'){
		...
		$phytally=$stally->getSubjectTally('physicsgrade','A',$term,$year,$form," and classin='$strm'");
		$phyas=$phytally['tally'];
		$phyA=$phyas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$phytally=$stally->getSubjectTally('physicsgrade','B+',$term,$year,$form," and classin='$strm'");
		$phybp=$phytally['tally'];
		$phyBP=$phybp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$phytally=$stally->getSubjectTally('physicsgrade','C+',$term,$year,$form," and classin='$strm'");
		$phycp=$phytally['tally'];
		$phyCp=$phycp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$phytally=$stally->getSubjectTally('physicsgrade','D+',$term,$year,$form," and classin='$strm'");
		$phydp=$phytally['tally'];
		$phyDp=$phydp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$phytally=$stally->getSubjectTally('physicsgrade','E',$term,$year,$form," and classin='$strm'");
		$phyde=$phytally['tally'];
		$phyE=$phyde*1;
	}
	...
	$getphystudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and physics>0");
	}
	...
	if($strm=='Entire'){
		...
		$histally=$stally->getSubjectTally('historygrade','A',$term,$year,$form," and classin='$strm'");
		$hisas=$histally['tally'];
		$hisA=$hisas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$histally=$stally->getSubjectTally('historygrade','B+',$term,$year,$form," and classin='$strm'");
		$hisbp=$histally['tally'];
		$hisBP=$hisbp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$histally=$stally->getSubjectTally('historygrade','C+',$term,$year,$form," and classin='$strm'");
		$hiscp=$histally['tally'];
		$hisCp=$hiscp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$histally=$stally->getSubjectTally('historygrade','D+',$term,$year,$form," and classin='$strm'");
		$hisdp=$histally['tally'];
		$hisDp=$hisdp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$histally=$stally->getSubjectTally('historygrade','E',$term,$year,$form," and classin='$strm'");
		$hisde=$histally['tally'];
		$hisE=$hisde*1;
	}
	...
	$gethisstudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and history>0");
	}
	...
	if($strm=='Entire'){
		...
		$geotally=$stally->getSubjectTally('geographygrade','A',$term,$year,$form," and classin='$strm'");
		$geoas=$geotally['tally'];
		$geoA=$geoas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$geotally=$stally->getSubjectTally('geographygrade','B+',$term,$year,$form," and classin='$strm'");
		$geobp=$geotally['tally'];
		$geoBP=$geobp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$geotally=$stally->getSubjectTally('geographygrade','C+',$term,$year,$form," and classin='$strm'");
		$geocp=$geotally['tally'];
		$geoCp=$geocp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$geotally=$stally->getSubjectTally('geographygrade','D+',$term,$year,$form," and classin='$strm'");
		$geodp=$geotally['tally'];
		$geoDp=$geodp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$geotally=$stally->getSubjectTally('geographygrade','E',$term,$year,$form," and classin='$strm'");
		$geode=$geotally['tally'];
		$geoE=$geode*1;
	}
	...
	$getgeostudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and geography>0");
	}
	...
	if($strm=='Entire'){
		...
		$cretally=$stally->getSubjectTally('cregrade','A',$term,$year,$form," and classin='$strm'");
		$creas=$cretally['tally'];
		$creA=$creas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$cretally=$stally->getSubjectTally('cregrade','B+',$term,$year,$form," and classin='$strm'");
		$crebp=$cretally['tally'];
		$creBP=$crebp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$cretally=$stally->getSubjectTally('cregrade','C+',$term,$year,$form," and classin='$strm'");
		$crecp=$cretally['tally'];
		$creCp=$crecp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$cretally=$stally->getSubjectTally('cregrade','D+',$term,$year,$form," and classin='$strm'");
		$credp=$cretally['tally'];
		$creDp=$credp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$cretally=$stally->getSubjectTally('cregrade','E',$term,$year,$form," and classin='$strm'");
		$crede=$cretally['tally'];
		$creE=$crede*1;
	}
	...
	$getcrestudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and cre>0");
	}
	...
	if($strm=='Entire'){
		...
		$agrtally=$stally->getSubjectTally('agriculturegrade','A',$term,$year,$form," and classin='$strm'");
		$agras=$agrtally['tally'];
		$agrA=$agras*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$agrtally=$stally->getSubjectTally('agriculturegrade','B+',$term,$year,$form," and classin='$strm'");
		$agrbp=$agrtally['tally'];
		$agrBP=$agrbp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$agrtally=$stally->getSubjectTally('agriculturegrade','C+',$term,$year,$form," and classin='$strm'");
		$agrcp=$agrtally['tally'];
		$agrCp=$agrcp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$agrtally=$stally->getSubjectTally('agriculturegrade','D+',$term,$year,$form," and classin='$strm'");
		$agrdp=$agrtally['tally'];
		$agrDp=$agrdp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$agrtally=$stally->getSubjectTally('agriculturegrade','E',$term,$year,$form," and classin='$strm'");
		$agrde=$agrtally['tally'];
		$agrE=$agrde*1;
	}
	...
	$getagrstudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and agriculture>0");
	}
	...
	if($strm=='Entire'){
		...
		$bsttally=$stally->getSubjectTally('businesStudiesgrade','A',$term,$year,$form," and classin='$strm'");
		$bstas=$bsttally['tally'];
		$bstA=$bstas*12;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$bsttally=$stally->getSubjectTally('businesStudiesgrade','B+',$term,$year,$form," and classin='$strm'");
		$bstbp=$bsttally['tally'];
		$bstBP=$bstbp*10;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$bsttally=$stally->getSubjectTally('businesStudiesgrade','C+',$term,$year,$form," and classin='$strm'");
		$bstcp=$bsttally['tally'];
		$bstCp=$bstcp*7;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$bsttally=$stally->getSubjectTally('businesStudiesgrade','D+',$term,$year,$form," and classin='$strm'");
		$bstdp=$bsttally['tally'];
		$bstDp=$bstdp*4;
	}
	if($strm=='Entire'){
	...
	if($strm=='Entire'){
		...
		$bsttally=$stally->getSubjectTally('businesStudiesgrade','E',$term,$year,$form," and classin='$strm'");
		$bstde=$bsttally['tally'];
		$bstE=$bstde*1;
	}
	...
	$getbststudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and businesStudies>0");
	}
	...
	$getfrenchStudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and french > 0");
	}
	...
	$gethomeStudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and home>0");
	}
	...
	$getcomputerStudents = mysql_query("select count(adm) as adms from totalygradedmarks where term='$term' and year='$year' and form='$form' and classin='$strm' and computer>0");
	}
