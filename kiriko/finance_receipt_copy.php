...
?>
  <div id="openModal1" class="modalDialog">
	  ...
	  <form name="subjectform" action="finance_cancelReceipt.php" method="post">
	...
	<div id="openModal2" class="modalDialog">
      <div> <a href="#close" title="Close" class="close">X</a>
	  <form name="subjectform" action="finance_cancelReceiptUndo.php" method="post">
          <table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
            <tr style='height:30px;'>
              <td class='dataListHeader' colspan='4'><i class="icon icon-green icon-info"></i>&nbsp;Undo Cancel Receipt: <?php echo $serial?></td>
            </tr>
	  <tr><td align="center"><h1>Warning you are about to undo cancel this receipt</h1><h3><?php echo $serial?></h3></td></tr>
	   <tr>
	   <td class="alterCell3">
	   <table width="100%">
	   <tr>
	...
	<div id="openModal" class="modalDialog">
	  ...
	  <form name="subjectform" action="delete_receipt.php" method="post">
          <table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
            <tr style='height:30px;'>
              <td class='dataListHeader' colspan='4'><i class="icon icon-green icon-info"></i>&nbsp;Delete Receipt: <?php echo $serial?></td>
            </tr>
	  <tr><td align="center"><h1>Warning you are about to delete this receipt</h1><h3><?php echo $serial?></h3></td></tr>
	   <tr>
	   <td class="alterCell3">
	   <table width="100%">
	   <tr>
        ...
        <table width="100%;">
          <tr>
            <td align="center"><a href="finance_receipt_copy.php?id=<?php echo $serial?>&date4=<?php echo $from?>&date5=<?php echo $to?>"  class="noline" title="Refresh Page"><i class="icon icon-orange icon-refresh"></i>Refresh</a></td>
			 ...
			 <td align="center"><a href="#openModal1" class="noline" title="Cancel Receipt"><i class="icon icon-orange icon-cancel"></i>Cancel Receipt</a></td>
            <?php 
			if ($status !="OK")
			{
			?>
			<td align="center"><a href="#openModal2" class="noline" title="Cancel Receipt"><i class="icon icon-orange icon-cancel"></i>Undo Cancel</a></td>
			
			<?php }
			$sqlno="select receipt_no  as last from finance_feestructures order by receipt_no desc limit 1 ";
			$getStdno = mysql_query($sqlno);
	while ($rowd= mysql_fetch_array($getStdno )) {
	
	$last=$rowd['last']; 
			}
			if ( $serial ==$last){?>
			<td align="center"><a href="#openModal" class="noline" title="Cancel Receipt"><i class="icon icon-orange icon-trash"></i>Delete Receipt</a></td>
  ...
  <td><div id=tableReceipt>
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd11 )) {
		...
		$amount=str_replace("_"," ",$rowstudenc['votehead_amt']);
			...
			$baltitle="Balance TERM 1";
		 }	//end of while
		 
		 
		  $sqlquly2 = "select * from finance_feestructures where receipt_no ='$serial' and term='TERM 2' and votehead_amt>0 having votehead_amt>0 ORDER by  votehead ASC ";
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd12 )) {
		...
		$amount=str_replace("_"," ",$rowstudenc['votehead_amt']);
			...
			$baltitle="Balance TERM 2";
		 }	//end of while
		
		
		 $sqlquly3 = "select * from finance_feestructures where receipt_no ='$serial' and term='TERM 3' and votehead_amt>0 having votehead_amt>0 ORDER by  votehead ASC";
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd13 )) {
		...
		$amount=str_replace("_"," ",$rowstudenc['votehead_amt']);
			...
			if($balance<0){
				$baltitle="OverPayment Next Year";
			}else{
				
			$baltitle="Balance TERM 3";
			}
		 }	//end of while
