...
<div id="page_tabs">
  <ul>
    <li><a  href="report_forms.php">General Report Forms</a></li>
    <li><a  class="active"  href="report_forms_cluster.php">Cluster Report Forms</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
    <fieldset>
    <form name="pays" action="report_forms_view_mock.php" method="get" target="reportView">
      <table width="100%">
	  <tr>
          <td>Analysis Mode:</td>
