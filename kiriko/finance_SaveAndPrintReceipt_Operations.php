...
VALUES ('$serial','Operation','$date','$modeofpay','Operations','$votehead1','$cashes[$counter]','$term','$year','OK','$username','$amount','$words','$bankname','-','Operation Income','$bankreceipt') on duplicate key update receipt_no='$serial'";
            ...
            <table width="100%" border="0">
             <tr>
			  ...
			  <tr>
                ...
                <td colspan="5"><span id="receiptText">Operation <?php echo $year." ".$term?></span></td>
              </tr>
            </table></td>
	 ...
	 while ($rowstudenc= mysql_fetch_array($getStd1 )) {
		...
		if($cashes[$counters]==0){
			 ...
			 echo "<tr><td><span id=receiptText>$votehead1s &nbsp;</span></td>
				<td><span id=receiptText>Operation $term &nbsp;&nbsp;$year</span></td>
