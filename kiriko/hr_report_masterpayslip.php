...
<div id="page_tabs">
  <ul>
    <li><a class="active" href="hr_report_masterpayslip.php">Master Payslip List</a></li>
  </ul>
</div>
<div id="display_Area">
<div id="page_tabs_content">
  <fieldset style="margin-bottom: 3px;">
  <form method="get" action="hr_view_report_masterpayslip.php" target="reportView">
    <fieldset>
    <legend>Payrolls Filter</legend>
    <table width="90%">
      <tr>
        <td><table width="100%">
            <tr>
  ...
  <iframe name="reportView" src="hr_view_report_masterpayslip.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
</div>
</div>
<!--end of display area. 
