...
<div id="page_tabs">
  <ul>
        ...
        <li><a class="active" href="finance_operationalcashbooksettings.php">Operational Cashbook Setting</a></li>
...
<div id="display_Area">
  <div id="page_tabs_content">
	...
	$qury="insert into finance_operationalvoteheads (fiscal_year,term,votehead,code) values ('$year','$term','$votehead','$code') on duplicate key update fiscal_year='$year', term='$term', votehead='$votehead', code='$code'";
	...
	$func->addAuditTrail($activity,$username);
		echo "<script language=javascript>alert('Votehead Added Successfuly') </script>";
		 echo "<script language=javascript>window.location='finance_operationalcashbooksettings.php' </script>";
	}
	}
	
?>
    <?php
    $result = mysql_query("SELECT * FROM finance_operationalvoteheads order by fiscal_year asc,term asc, votehead asc");
...
var info = 'id=' + del_id;
 ...
 $.ajax({
   type: "GET",
   url: "delete_finance_operationalvotehead.php",
   data: info,
   success: function(){
