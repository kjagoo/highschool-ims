    ...
    <tr>
      <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		...
		?>
            ...
            <tr class='record'>
	<td><?php echo $num?></td>
	<td><a class='noline' href="hr_viewcreatepayslips.php?id=<?php echo $row['idpass']?>&sal=<?php echo $row['salary']?>"><?php echo str_replace("&","'",$row['fname']).'&nbsp;&nbsp;'.str_replace("&","'",$row['mname']).'&nbsp;&nbsp;'.str_replace("&","'",$row['lname'])?></td>
