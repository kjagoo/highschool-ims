...
<div id="page_tabs">
  <ul>
     <li><a  href="finance_paybills.php">Pay Bills/ Suppliers</a></li>
	<li><a  class="active" href="finance_paidbills_list.php">Paid Bills/ Suppliers </a></li>
  </ul>
</div>
<div id="display_Area">
  ...
  <tr style='height:30px;'>
    <td class='dataListHeader' colspan='4'>Paid Bills/ Suppliers
      <div style="float:right; margin-right:20px; width:60%;">
        <table width="80%" align="right">
          <tr>
            <td align="right"><a href="finance_paidbills_list.php" title="Refresh Page"><i class="icon icon-green icon-refresh"></i>Refresh</a></td>
          </tr>
        </table>
      </div></td>
  </tr>
  <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <?php
		$totals=0;
		  $result = mysql_query("SELECT * FROM finance_paybills order by t_date asc");
		$num=0;
