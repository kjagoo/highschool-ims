      ...
      <table class='borders' cellpadding='5' cellspacing="0">
        <tr style='height:30px;'>
		  ...
		  <div style="float:right; margin-right:5px;">
		  	<table width="200px">
		  	<tr>
			<td align="left"><a href="finance_set_fees_additional.php?form=<?php echo $form;?>&term=<?php echo $term;?>&yr=<?php echo $year;?>"><i class="icon icon-green icon-refresh"></i>Refresh</a></td>
			
			<td align="right"><a href="finance_additional_Fees.php"><i class="icon icon-red icon-close"></i>close</a></td>
			</tr>
			</table>
			</div>
		  </td>
      ...
      <div> <a href="#close" title="Close" class="close">X</a>
        <form name="subjectform" action="finance_updateFees.php" method="post">
          <table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
            <tr style='height:30px;'>
              <td class='dataListHeader' colspan='4'><i class="icon icon-green icon-info"></i>&nbsp; <font color="#FFFFFF">Editing Fees Record <?php echo $admno?></font></td>
            </tr>
            <tr>
		  ...
		  <input type="hidden" name="yr" value="<?php echo $year; ?>">'
				...
				<td align="center"><a href="pdf_fees_invoice.php?form=<?php echo $form;?>&term=<?php echo $term;?>&yr=<?php echo $year;?>&admno=<?php echo $admno?>"><i class="icon icon-green icon-document"></i>Invoice</a></td>
              </tr>
