...
<div id="page_tabs_content">
  ...
  <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    <table width="100%" class="tablesorter_ordinary">
      <tr>
		...
		<td ><span id="freetext">Exam Type</span></td>
              <td><select name="cats" class="select" required tabindex="5">
			   <option value="" >--Select -- </option>
  ...
  <?php
	  include('includes/dbconnector.php');
	if (isset ($_POST['forms']) && isset ($_POST['stream']) && isset ($_POST['term'])  && isset ($_POST['year'])  && isset ($_POST['cats'])){
...
if($stream=='E'){
$query = "SELECT * FROM examstatus where year='$year' and term='$term' and form='$form' and examtype='$etype' group by stream,subject";
}else{
$query = "SELECT * FROM examstatus where year='$year' and term='$term' and form='$form' and stream='$stream' and examtype='$etype'  group by stream,subject";
}
...
$num_rows = mysql_num_rows($result);
 ...
 <table class='borders' cellpadding='5' cellspacing="0">
        <tr style='height:30px;'>
          <td class='dataListHeader' colspan='4'>Recorded Marks for Form <?php echo $form." ".$stream ?>Term <?php echo $term?>  Year <?php echo $year?>
