...
$pdf->setXY($x, $y);
	...
	$sql="select distinct(receipt_no), admno,dateofpay,modeofpay,total_amount from finance_feestructures where dateofpay between '$from' and '$to' and statusis='CANCELLED' order by receipt_no asc";
