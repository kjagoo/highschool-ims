...
<div id="page_tabs">
  <ul>
    <li><a  href="report_subjects_analysis.php">General Exams Subjects Analysis</a></li>
    <li><a class="active"   href="report_subjects_analysis_cluster.php">Cluster Exams Subjects Analysis</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
...
if($status=="locked"){
 ...
 ?>
  ...
  ?>
      <fieldset>
      <form name="pays" action="report_cluster_subject_analysis_view.php" method="get" target="reportView">
        <table width="100%">
          <tr>
            <td>Select Form:</td>
