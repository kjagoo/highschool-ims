        ...
        <form name="subjectform" action="student_leaving_certificate1.php" method="GET">
          <table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
            <tr style='height:30px;'>
			 ...
			 <tr>
			 <td width="20%">Ability</td>
              <td><textarea name='ability' rows="2" cols="20" autofocus  tabindex="1" ></textarea></td>
            </tr>
            <tr>
			<td>Conduct</td>
              <td><textarea name='conduct' rows="2" cols="20" autofocus  tabindex="1" ></textarea></td>
            </tr>
			<tr>
			<td>Co-Curricular</td>
              <td><textarea name='cirricular' rows="2" cols="20" autofocus  tabindex="1" ></textarea></td>
            </tr>
			
            <tr>
             
              <td class="alterCell3"><input type="submit" name="submit" value="Generate Certificate" class="btn btn-primary"/></td>
            </tr>
          </table>
