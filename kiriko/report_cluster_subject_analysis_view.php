                            ...
                            <div style="float:right; margin-right:5px;">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="left"><a href="pdf_test_cluster_analysis.php?form=<?php echo $form?>&class=<?php echo $stream?>&term=<?php echo $term?>&year=<?php echo $year?>" title="Print PDF Report"><i class="icon icon-red icon-pdf"></i>Export PDF</a> </td>
                                ...
                                <div id="div_print_analysis">
                                    ...
                                    foreach ($subjects AS $subject) {
                                        ...
                                        foreach ($allStreams as $strm) {
                                            ...
                                            //GET STUDENTS
                                            //$noOfStudents = getStudentsInClass($form, $strm, $term, $year, "totalygradedmockmarks");
...
function getGrades($subject1, $form1, $stream1, $term1, $year1, $subjectGrade) {
	...
	$englishtallys = $stally->getGradesPerSubjectEntireMock($subject1, $subjectGrade, $term1, $year1, $form1, $stream1);
