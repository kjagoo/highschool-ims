...
?>
    <form name="demo" method="post" action="saveBalances.php">
      <table class='borders table-striped table-bordered' cellpadding='5' cellspacing="0">
        <tr style='height:30px;'>
          <td class='dataListHeader' colspan='4'>Recording <u><?php echo $form?></u>&nbsp;&nbsp;Fees Balances <u> <?php echo $term?></u>&nbsp;&nbsp;<u>Year  &nbsp;<?php echo $year?></u>
	...
	$balance=0;
	$queryb = "SELECT * FROM finance_balances where admno='$adm' and year='$year' and term='$term'";
	...
	?>
        <tr>
          ...
          <td ><input type="text"  name="subject" id="inputMarks" size="15" tabindex='<?php echo $index?>' value="<?php echo $balance?>" onkeyup="return checkInput(this.value)" ></td>
        </tr>
        <?php 	  
}//end of while
	?>
