...
<div id="page_tabs">
  <ul>
     <li><a  class="active" href="sms_teachers.php">SMS to Teachers</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
 <div id="page_tabs_content">
 <form id="contact-form" action="send_sms_to_teachers.php" name="sendsms" method="post">
                   <table class="borders" cellpadding="5" cellspacing="0">
        <tr style="height:30px;">
          <td class="dataListHeader" colspan="2">Send Message To Teachers</td>
        </tr>
                      <tr>
                        <td>Send to:</td>
                      ...
                      <tr>
                        ...
                        <td><select name="category" id="category"  class="select" tabindex="2">
                            <option value="select" selected="selected">- Select Category -</option>
                            <option value="bog">BOG Teachers</option>
                            <option value="tsc">TSC Teachers</option>
...
onKeyUp="limitText(this.form.message,this.form.countdown1,160);" placeholder="Type Message Here" tabindex="3" required autofocus></textarea><br/>
</td>
                      </tr>
