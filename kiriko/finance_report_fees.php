...
<div id="page_tabs">
  <ul>
   <li><a href="finance_report_statements.php">Fees Statements</a></li>
    <li><a class="active" href="finance_report_fees.php">Fees Balances</a></li>
...
<div id="page_tabs_content">
  <fieldset>
	<form method="GET" action="finance_report_view_feesbalances.php" target="reportView">
     <table width="100%">
        <tr>
          <td>
		 ...
		 <select name="term" class="select" required>
		  ...
		  <td><input type="submit" name="submit" value="View Balances" class="btn btn-primary"/></td>
        </tr>
		<tr>
		<td colspan="3"><table width="85%">
            <tr>
              <td>Range From</td>
   ...
   <iframe name="reportView" src="finance_report_view_feesbalances.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
