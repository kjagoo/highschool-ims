...
$func = new Functions();
$activity = "Printed ".$admno." Report form";
...
/*********************************************************************************/
	...
	$getTotalstudentsClass = mysql_query("select count(adm) as adms from totalygradedmidterm where term='$term' and year='$year' and form='$form' and stream='$strm'");
	...
	$examtotals=0;
	$examtotals=$enge+$kise+$mathe+$bioe+$cheme+$phye+$hise+$geoe+$cree+$agre+$bste+$compe+$free+$msce+$homee;
...
$nexttermopens="";
	...
	$feepayable="0";
	$feearrq=mysql_query("select SUM(amount) as payable from finance_fees where form='$myform' and term='$myterm' and fiscal_yr='$year'");
...
/*****************************************************************************************/
	...
	$mscinitials="-";
	$mscint=mysql_query("select initials from initials where  form='$myform' and stream='$strm' and subject='MUSIC'");
	while ($rowmsc = mysql_fetch_array($mscint)) {// get admno
	$mscinitials=$rowmsc['initials'];
	}
	/*********************************************************************************/
...
$pdf->Image($image1,170,5,25,25);
$pdf->Image($logo,18,5,25,25);
...
$pdf->Text(70, 30, $report.' Report Form: 	TERM:'.$term.'  Year:  '.$year);
...
$pdf->Rect(15, 42, 180, 80);// the rectangle left,top,width, height
...
$pdf->Text(17, 116, '511-Music');
$pdf->Line(15, 117, 195, 117);
$pdf->Text(17, 121, '565-B/Studies');
...
$pdf->Text(55, 96, $home);
$pdf->Text(55, 101, $agr);
$pdf->Text(55, 106, $comp);
$pdf->Text(55, 111, $fre);
$pdf->Text(55, 116, $msc);
$pdf->Text(55, 121, $bst);
}
if($examreport=='2'){
$pdf->Line(45, 42, 45, 122);//Next Column
$pdf->Text(55, 46, 'CAT2');
$pdf->Text(55, 51, $eng2);
$pdf->Text(55, 56, $kis2);
$pdf->Text(55, 61, $math2);
$pdf->Text(55, 66, $bio2);
$pdf->Text(55, 71, $phy2);
$pdf->Text(55, 76, $chem2);
$pdf->Text(55, 81, $his2);
$pdf->Text(55, 86, $geo2);
$pdf->Text(55, 91, $cre2);
$pdf->Text(55, 96, $home2);
$pdf->Text(55, 101, $agr2);
$pdf->Text(55, 106, $comp2);
$pdf->Text(55, 111, $fre2);
$pdf->Text(55, 116, $msc2);
$pdf->Text(55, 121, $bst2);
}
if($examreport=='12'){
$pdf->SetFont('times', '', 10);
$pdf->Line(45, 42, 45, 122);//create next collumn
...
if($examreport=='1'){
$pdf->Text(55, 126, $cat1totals);
}
if($examreport=='2'){
$pdf->Text(55, 126, $cat2totals);
}
if($examreport=='12'){
