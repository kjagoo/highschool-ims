...
<div id="page_tabs">
  <ul>
    <li><a href="hr_deductions.php">Income Tax (P.A.Y.E.)</a></li>
	 ...
	 <li><a class="active" href="hr_deductions_nssf.php">NSSF</a></li>
	 <li><a href="hr_deductions_loans.php">Other Deductions</a></li>
  </ul>
</div>
<div class="clear"></div>
<div id="display_Area">
   <div id="page_tabs_content">
    <fieldset>
     <table width="80%">
        <tr>
          <td valign="middle" rowspan="2"><a href="#openModal" class="btn btn-primary noline"><span class="icon icon-green icon-plus"></span> New NSSF Setting</a></td>
        </tr>
      </table>
    </fieldset>
        ...
        <form name="subjectform" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
          <table class="borders" style="margin-bottom: 5px;" cellpadding="5" cellspacing="0" width="100%">
            <tr style='height:30px;'>
              <td class='dataListHeader' colspan='4'><i class="icon icon-green icon-info"></i>&nbsp;NSSF Settings</td>
            </tr>
			<tr>
			...
			<tr>
              <td class="alterCell" width="20%"><b>Pensionable:</b></td>
              <td class="alterCell2"><input type="number" name="pen" class="inputFields"  required  tabindex="3"/></td>
            </tr>
			<tr>
              <td class="alterCell" width="20%"><b>Pecentage %:</b></td>
	...
	$qury="insert into tbl_hr_nssf (minv,maxv,amount,percent) values ('$min','$max','$pen','$tax')";
	$resultq = mysql_query($qury);
	if(!$resultq){
	die('Invalid query: ' . mysql_error());
	}else{
		echo "<script language=javascript>alert('NSSF Setting Added Successfuly') </script>";
		 echo "<script language=javascript>window.location='hr_deductions_nssf.php' </script>";
	}
	}
	
?>
    <?php
    $result = mysql_query("SELECT * FROM tbl_hr_nssf order by minv asc");
	
		?>
    <table class="borders" cellpadding="5" cellspacing="0">
      <tr style="height:30px;">
        <td class="dataListHeader">Default NSSF Settings</td>
      </tr>
      <tr>
