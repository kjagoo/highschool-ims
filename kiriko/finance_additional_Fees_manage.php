...
<div id="page_tabs">
  <ul>
	<li><a   href="finance_additional_Fees.php">Add Additional Fees</a></li>
	<li><a class="active"   href="finance_additional_Fees_manage.php">Edit Additional Fees</a></li>
  </ul>
</div>
<div id="display_Area">
  ...
  <fieldset>
    <form name="pays" action="finance_set_fees_additional_manage.php" method="get" target="reportView">
      <table width="100%">
        <tr>
		<td> Year:</td>
          <td><select name="yr" class="select">
              <?php
			  $curryr=date("Y");
			   for($i = 2015; $i <= $curryr +2; $i++) 
          ...
          <td><select name="term" class="select">
           ...
           <td>Admission No:</td>
          <td><input type="text" name="admno" class="inputFields"  /> </td>
		 ...
		 <iframe name="reportView" src="finance_setFees_Default_A.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
