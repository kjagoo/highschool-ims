...
<div id="page_tabs">
  <ul>
    <li><a class="active" href="finance_report_analysis.php">Trial Balance</a></li>
    <li><a  href="finance_report_balancesheet.php">Balance Sheet</a></li>
...
<div id="display_Area">
  <div id="page_tabs_content">
    ...
    <form method="GET" action="finance_report_view_trialbalance.php" target="reportView">
      <table width="80%">
        <tr>
                        <td>From Date</td>
                        <td><?php
				...
				//  $myCalendar->dateAllow('2008-05-13', '2015-03-01');
				  ...
				  $myCalendar->writeScript();
					?>
						...
						<td>
			  <select name="mainaccount" id="mainaccount" class="select" tabindex="1" required autofocus/>
    ...
    <iframe name="reportView" src="finance_report_view_trialbalance.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
  </div>
</div>
