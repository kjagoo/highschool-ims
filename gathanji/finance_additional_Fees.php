...
<div id="page_tabs">
  <ul>
	<li><a  class="active"  href="finance_additional_Fees.php">Add Additional Fees</a></li>
  </ul>
</div>
<div id="display_Area">
  ...
  <fieldset>
    <form name="pays" action="finance_set_fees_additional.php" method="get" target="reportView">
      <table>
        <tr>
		<td> Year:</td>
          <td><input type="text" readonly="readonly" name="yr" class="inputFields" style="background-color:#FFFFCC" value="<?php echo $finance->getFiscalYear()?>" /></td>
          <td>Select Form:</td>
