...
//$pdf->SetFont('arial', '', 12);
	...
	$Numbers = @mysql_query("select count(adm) as total from totalygradedmockmarks  where form='$form' and term='$term' and year='$year' and classin='$strm'");
	@mysql_query($Numbers);
	...
	$myqueryis="select * from totalygradedmockmarks where  term='$term' and year='$year' and form='$form' and classin='$strm' order by averagepoints desc, average desc";
	...
	$pdf -> RotatedText(30,100,$fname." ".$mname." ".$lasname,10);
	$pdf -> RotatedText(30,250,$fname." ".$mname." ".$lasname,10);
	...
	while ($rowf1m = mysql_fetch_array($form1mean)) {
...
$nextyear=($year+1);
	...
	//this can be changed if the calculation is to be changed
	//for now we put 1, 1 meaning the data will be raw data
	$cat1per = 1;
	$cat1standard = 1;
...
if(!file_exists("Image/".$admno.".jpg"))
 ...
 $image1 = "Image/".$admno.".jpg";
  ...
  $bioinitials="-";
	...
	$bioinitials=$bioinitials;
	}
if($phyfinal==0){
$phyinitials="-";
}else{
	$phyinitials=$phyinitials;
}
if($chemfinal==0){
$cheminitials="-";
}else{
$cheminitials=$cheminitials;
}
if($hisfinal==0){
$hisinitials="-";
}else{
$hisinitials=$hisinitials;
}
if($geofinal==0){
$geoinitials="-";
}else{
 $geoinitials=$geoinitials;
}
if($crefinal==0){
$creinitials=$creinitials;
}else{
$creinitials=$creinitials;
}
if($homefinal==0){
...
$agrinitials=$agrinitials;
}
if($compfinal==0){
$compinitials="-";
}else{
 $compinitials=$compinitials;
}
if($frefinal==0){
$freinitials="-";
}else{
$freinitials=$freinitials;
}
if($bstfinal==0){
$bstinitials= "-";
}else{
 $bstinitials=$bstinitials;
}
...
$pdf->Text(70, 122, 'Total Marks      '.$tmarks.'        Out of  :'  .$totalOutOf).

//$pdf->Text(20, 128, 'Mean: 	   '.$meangrade.'         Grade:	 '.$gradepoints.'         Position This Term:	      '.$studentPos .'       Out Of:  '.$totalStudents).
