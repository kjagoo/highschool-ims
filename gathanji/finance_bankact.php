        ...
        <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			?>
              <tr class="record">
                ...
                <td align="center"><a href="#" id="<?php echo $row["account_number"]; ?>" class="delbutton"><span class="icon icon-orange icon-trash"></span> </a></td>
                 <td align="center"><a href="#" id="<?php echo $row["account_number"]; ?>" class="delbutton"><span class="icon icon-orange icon-edit"></span> </a></td>
              </tr>
              <?php
			}
		?>
