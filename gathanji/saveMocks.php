...
$act="insert into mockexams 
   ...
   $tostatus="insert into examstatus (year,term,form,stream,subject,examtype,status) values('$year','$term','$form','$strm','$subject','$sub','Recorded')";
...
$act="insert into mockexams 
  ...
  $tostatus="insert into examstatus 
	...
	values('$year','$term','$form','$strm','$subject','$sub','Recorded') ";
	$tostatusRe=mysql_query($tostatus);
