...
if($count==0){
$query="insert into messages_settings (api_url,ekey,senderid,passwrd) 
	values('$api','$key','$sid','$passw') 
	on duplicate key update api_url='$api', ekey='$key', senderid='$sid',passwrd='$passw'";
}else{
	$query=" update messages_settings set api_url='$api', ekey='$key', senderid='$sid',passwrd='$passw'";
}
