...
<div id="display_Area">
 ...
 if($usercat=='Administrator' || $usercat=='Government Teacher' || $usercat=='Board Teacher' || $usercat=='Dean'){
  //<fieldset>
  ?>
	 ...
	 ?>
		  ...
		  <a data-rel="tooltip" title="Quick link to Timetable" class="well span3 top-block" href=javascript:executeCommands()> <span><img src="images/timetable.png" alt="Timetable" /></span>
          <div>&nbsp;</div>
          <div>Time Table</div>
          </a> 
