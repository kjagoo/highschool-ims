...
$posq2="SELECT t2.*, ROWNUM1 FROM (
    SELECT q1.*, MIN(q1.rownum) AS rownum1 FROM 
    (SELECT t1.".$positionby.",t1.".$alternatepositionby.", @rownum:=@rownum + 1 AS rownum1
