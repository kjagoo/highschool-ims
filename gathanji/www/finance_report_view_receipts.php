...
if( (isset($_REQUEST["date4"]) ? $_REQUEST["date4"] : "") || (isset($_REQUEST["date5"]) ? $_REQUEST["date5"] : "") ){
 require_once("includes/dbconnector.php"); 
	...
	$sql="select distinct(receipt_no), admno,dateofpay,modeofpay,total_amount from finance_feestructures where dateofpay between '$from' and '$to' order by receipt_no asc";
