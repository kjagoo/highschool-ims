...
<?php }
	 if($usercat=='Administrator' || $usercat=='Secretary' || $usercat=='Government Teacher' || $usercat=='Board Teacher' || $usercat=='Dean' ||  $usercat=='Accountant'){ 
...
if($usercat=='Administrator' || $usercat=='Dean'){ ?>
    <li><a class="menu" href="dean_main.php" target="main"><i class="icon icon-green icon-contacts"></i>&nbsp;Dean Settings</a></li>
    <?php
 }
