...
<div id="page_tabs">
  <ul>
    <li><a class="active" href="hr_report_nhif.php">NHIF Reports</a></li>
  </ul>
</div>
<div id="display_Area">
<div id="page_tabs_content">
  <fieldset style="margin-bottom: 3px;">
  <form method="get" action="hr_view_report_nhif.php" target="reportView">
    <fieldset>
  ...
  <iframe name="reportView" src="hr_view_report_nhif.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
</div>
</div>
<!--end of display area. 
