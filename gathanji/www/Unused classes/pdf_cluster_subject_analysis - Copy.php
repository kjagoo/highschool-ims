...
function Header(){
	...
	$this->Text(75, 35, 'Cluster Exams Subjects Analysis Form '.$form.' '.$strm.' Term '.$term.' Year '.$year);
...
include 'includes/PerformanceIndicator.php';
	$pin = new PI();
	$pin->getPICluster($form,$term,$strm,$year,"Exam");
...
$englishas = 0; 
	...
	$englishtallys = $stally -> getGradesPerSubjectMockEntireMock("english","englishgrade", $term,$year,$form); 
...
//************************************************** french **************************************************************************
 ...
 $frenchde = 0;  
	...
	$frenchtallys = $stally -> getGradesPerSubjectMockEntireMock("french","frenchgrade", $term,$year,$form); 
	}else{
 ...
 $homede = 0;  
	...
	$hometallys = $stally -> getGradesPerSubjectMockEntireMock("home","homegrade", $term,$year,$form); 
	}else{
...
//***************************************************************************************************
 ...
 $computerde = 0;  
	...
	$computertallys = $stally -> getGradesPerSubjectMockEntireMock("computer","computergrade", $term,$year,$form); 
	}else{
