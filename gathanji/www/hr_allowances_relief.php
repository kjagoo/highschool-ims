...
<div id="display_Area">
  <div id="page_tabs_content">
	...
	$qury="insert into tbl_hr_reliefs (name,amount) values ('$name','$min') on duplicate key update percent=percent";
...
?>
	...
	$min=$_POST['minvu'];
	$date=date("Y-m-d H:i:s a");
	$qury="update tbl_hr_reliefs set amount='$min' where name='$name'";
	$resultq = mysql_query($qury);
	if(!$resultq){
	die('Invalid query: ' . mysql_error());
	}else{
