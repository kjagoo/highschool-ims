...
VALUES ('$serial','Tutition','$date','$modeofpay','$votehead1','$cashes[$counter]','$term','$year','OK','$username','$amount','$words','$bankname','-','Tution Income','$bankreceipt') on duplicate key update receipt_no='$serial'";
