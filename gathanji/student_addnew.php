	 ...
	 <table class="borders" cellpadding="5" cellspacing="0">
        ...
        <table width="80%" align="right">
          ...
          <tr>
            ...
            <td >Age:</td>
            <td><input type="number" size="25" name="age" class="inputFields" tabindex="7" required  /></td>
          </tr>
          <tr>
            <td >Religion:</td>
          ...
          <tr>
            <td >Last Name:</td>
            <td><input type="text" size="35" name="plname" class="inputFields" tabindex="19" required autofocus/></td>
            <td >ID/Passport:</td>
            <td><input type="text" size="35" name="idpass" class="inputFields" tabindex="20" required autofocus/></td>
          </tr>
          <tr>
            <td >Address:</td>
            <td><input type="text" size="35" name="address" class="inputFields" tabindex="21" required autofocus/></td>
            <td >Telephone:</td>
