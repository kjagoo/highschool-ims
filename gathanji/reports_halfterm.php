...
$cat2standard=$rows['cat2'];
	...
	$eng=round_up ((($eng1+$eng2)/($cat1standard+$cat2standard))*100,0);
	$kis=round_up ((($kis1+$kis2)/($cat1standard+$cat2standard))*100,0);
	$math=round_up ((($math1+$math2)/($cat1standard+$cat2standard))*100,0);
	$bio=round_up ((($bio1+$bio2)/($cat1standard+$cat2standard))*100,0);
	$chem=round_up ((($chem1+$chem2)/($cat1standard+$cat2standard))*100,0);
	$phy=round_up ((($phy1+$phy2)/($cat1standard+$cat2standard))*100,0);
	$his=round_up ((($his1+$his2)/($cat1standard+$cat2standard))*100,0);
	$geo=round_up ((($geo1+$geo2)/($cat1standard+$cat2standard))*100,0);
	$cre=round_up ((($cre1+$cre2)/($cat1standard+$cat2standard))*100,0);
	$agr=round_up ((($agr1+$agr2)/($cat1standard+$cat2standard))*100,0);
	$bst=round_up ((($bst1+$bst2)/($cat1standard+$cat2standard))*100,0);
	$fre=round_up ((($fre1+$fre2)/($cat1standard+$cat2standard))*100,0);
	$comp=round_up ((($comp1+$comp2)/($cat1standard+$cat2standard))*100,0);
	$home=round_up ((($home1+$home2)/($cat1standard+$cat2standard))*100,0);
