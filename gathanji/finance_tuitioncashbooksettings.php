...
<div id="page_tabs">
  <ul>
        <li><a  href="finance_voteheads.php">Parents Cashbook Setting</a></li>
        <li><a  href="finance_operationalcashbooksettings.php">Operational Cashbook Setting</a></li>
        <li><a class="active" href="finance_tuitioncashbooksettings.php">Tuition Cashbook Setting</a></li>
  </ul>
</div>
<div id="display_Area">
  <div id="page_tabs_content">
	...
	$qury="insert into finance_tuitionvoteheads (fiscal_year,term,votehead,code) values ('$year','$term','$votehead','$code') on duplicate key update fiscal_year='$year', term='$term', votehead='$votehead', code='$code'";
	...
	$func->addAuditTrail($activity,$username);
		echo "<script language=javascript>alert('Votehead Added Successfuly') </script>";
		 echo "<script language=javascript>window.location='finance_tuitioncashbooksettings.php' </script>";
	}
	}
	
?>
    <?php
    $result = mysql_query("SELECT * FROM finance_tuitionvoteheads order by fiscal_year asc,term asc, votehead asc");
	
		?>
    <table class="borders" cellpadding="5" cellspacing="0">
      <tr style="height:30px;">
        <td class="dataListHeader">Tuition Voteheads:</td>
      </tr>
      <tr>
...
var info = 'id=' + del_id;
 ...
 $.ajax({
   type: "GET",
   url: "delete_finance_tuitionvotehead.php",
   data: info,
   success: function(){
