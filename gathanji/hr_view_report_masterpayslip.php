			...
			?>
  			<tr>
				...
				<td align="right"><?php echo $row['basic']?></td>
				 <td align="right"><?php echo $row['allaws']?></td> 
				   <td align="right"><?php echo ($row['allaws']+$row['basic'])?></td> 
                <td align="right"><?php echo $row['nhif']?></td>
				 <td align="right"><?php echo $row['nssf']?></td>
				  <td align="right"><?php echo $row['statutory']?></td>
				  <td align="right"><?php echo $row['paye']?></td>
				  <td align="right"><?php echo ((($row['allaws'])+($row['basic']))-($row['statutory']))?></td>
				 <td align="right"><?php echo $row['deds']?></td> 
				 <td align="right"><?php echo $row['netpay']?></td>
