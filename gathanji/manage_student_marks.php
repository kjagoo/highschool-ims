...
//if ($result) {
  ...
  ?>
        ...
        <tr>
		  ...
		  <thead>
              <tr>
                ...
                <th >Admno</th>
                <th >Full Name</th>
                <th align='righ't>WAT 1</th>
                <th align='right'>WAT 2</th>
	...
	$ads = "SELECT distinct(admno) FROM tbleperformancetrack where form='$form' and year='$year' and stream='$stream'";//admno query
	...
	$sub=0;
	$cat1 = "SELECT * FROM markscats where form='$form' and term='$term' and year='$year' and cat='1' and admno='$admno'";//cat 1 query
