...
$func = new Functions();
$dao = new DAO();
	$activity = "Viewed Student Performance Indicators";
	$username=$_SESSION['SESS_MEMBER_ID_'];
...
<table class="borders" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
		<?php
		$resultf = mysql_query("select * from totalperformanceindex where year='$year' and form='$form' and term='$term' and classin='$stream' and exam='$exam' order by pindex desc");
		$num=0;
