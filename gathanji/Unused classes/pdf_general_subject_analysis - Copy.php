...
function Header(){
	...
	$this->Text(75, 35, 'General Exams Subjects Analysis Form '.$form.' '.$strm.' Term '.$term.' Year '.$year);
...
$pdf->setFont("times","","9");
	...
	$pdf->RotatedText(40,155,$enginitials,280);
	$pdf->RotatedText(60,155,$kisinitials,280);
	$pdf->RotatedText(75,155,$mathinitials,280);
	$pdf->RotatedText(95,155,$bioinitials,280);	
	$pdf->RotatedText(115,155,$phyinitials,280);	
	$pdf->RotatedText(125,155,$cheminitials,280);
	$pdf->RotatedText(145,155,$hisinitials,280);
	$pdf->RotatedText(160,155,$geoinitials,280);
	$pdf->RotatedText(180,155,$creinitials,280);
	$pdf->RotatedText(190,155,$agrinitials,280);
	$pdf->RotatedText(210,155,$bstinitials,280);
	$pdf->RotatedText(230,155,$homeinitials,280);	
	$pdf->RotatedText(245,155,$compinitials,280);
	$pdf->RotatedText(265,155,$freinitials,280);
