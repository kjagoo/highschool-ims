...
$qurya = "INSERT INTO finance_feestructures(receipt_no, admno,dateofpay,modeofpay,votehead,votehead_amt,term,YEAR,statusis,servedby,total_amount,words,bank_account,balance,payment_for)
VALUES ('$serial','$from','$date','$modeofpay','Income','$amount','$term','$year','OK','$username','$amount','$words','$bankname','-','$source') on duplicate key update receipt_no='$serial'";
